...
export class ListasService {
  ...
  clasificacion: Piloto[]=this.pilotos;
  sprint: Piloto[]=this.pilotos;
  carrera: Piloto[]=this.pilotos;
  ...
  public updateClasificacion(array: Array<Piloto>): void {
    console.log('updateclasi: '+array);
    console.log(array);
    this._clasificacion.next(this.pilotos);
  };

  public updateSprint(array: Array<Piloto>): void {
    console.log('updatesprint: '+array)
    console.log(array);
    this._sprint.next(array);
  };

  public updateCarrera(array: Array<Piloto>): void {
    console.log('updatecareera: '+array);
    console.log(array);
